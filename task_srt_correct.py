...
async def main():
    ...
    parser.add_argument("--min_duration", help="min duration", default=2000)
    parser.add_argument("--min_word_count", help="min word count", default=4)
    parser.add_argument("--retry_count", help="retry count", default=2)
    ...
    await async_batch_exec(files, srt_correct, min_duration, min_word_count, retry_count)
